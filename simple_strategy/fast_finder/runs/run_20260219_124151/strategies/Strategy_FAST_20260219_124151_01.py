"""Generated strategy: Strategy_FAST_20260219_124151_01"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_signal_rule('rsi_osob', overbought_oversold, indicator='rsi_main', overbought=68, oversold=35)
    builder.add_signal_rule('rsi_trend_combo', rsi_mean_reversion_with_trend, rsi='rsi_main', ema_fast='ema_fast', ema_slow='ema_slow', overbought=65, oversold=16)
    builder.set_signal_combination('majority_vote')
    builder.set_strategy_info('Strategy_FAST_20260219_124151_01', '1.0.0')
