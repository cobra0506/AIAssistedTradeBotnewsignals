"""Generated strategy: Strategy_FAST_20260220_080627_01"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_indicator('ema_slow', ema, period=73)
    builder.add_indicator('rsi_main', rsi, period=14)
    builder.add_signal_rule('rsi_osob', overbought_oversold, indicator='rsi_main', overbought=85, oversold=28)
    builder.add_signal_rule('rsi_trend_combo', rsi_mean_reversion_with_trend, rsi='rsi_main', ema_fast='ema_fast', ema_slow='ema_slow', overbought=72, oversold=23)
    builder.set_signal_combination('majority_vote')
    builder.set_strategy_info('Strategy_FAST_20260220_080627_01', '1.0.0')
