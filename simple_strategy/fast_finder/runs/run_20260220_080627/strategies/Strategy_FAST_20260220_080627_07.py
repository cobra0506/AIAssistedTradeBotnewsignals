"""Generated strategy: Strategy_FAST_20260220_080627_07"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_indicator('ema_slow', ema, period=49)
    builder.add_indicator('rsi_main', rsi, period=16)
    builder.add_signal_rule('rsi_osob', overbought_oversold, indicator='rsi_main', overbought=82, oversold=34)
    builder.add_signal_rule('rsi_trend_combo', rsi_mean_reversion_with_trend, rsi='rsi_main', ema_fast='ema_fast', ema_slow='ema_slow', overbought=80, oversold=39)
    builder.set_signal_combination('unanimous')
    builder.set_strategy_info('Strategy_FAST_20260220_080627_07', '1.0.0')
