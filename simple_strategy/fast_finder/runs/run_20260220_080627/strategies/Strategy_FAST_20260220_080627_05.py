"""Generated strategy: Strategy_FAST_20260220_080627_05"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_indicator('ema_fast', ema, period=13)
    builder.add_indicator('ema_slow', ema, period=30)
    builder.add_indicator('rsi_main', rsi, period=17)
    builder.add_signal_rule('rsi_osob', overbought_oversold, indicator='rsi_main', overbought=68, oversold=15)
    builder.add_signal_rule('rsi_trend_combo', rsi_mean_reversion_with_trend, rsi='rsi_main', ema_fast='ema_fast', ema_slow='ema_slow', overbought=76, oversold=32)
    builder.set_signal_combination('unanimous')
    builder.set_strategy_info('Strategy_FAST_20260220_080627_05', '1.0.0')
