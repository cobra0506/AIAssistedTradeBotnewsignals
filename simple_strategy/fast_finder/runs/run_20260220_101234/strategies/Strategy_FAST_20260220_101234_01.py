"""Generated strategy: Strategy_FAST_20260220_101234_01"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_signal_rule('rsi_trend_combo', rsi_mean_reversion_with_trend, rsi='rsi_main', ema_fast='ema_fast', ema_slow='ema_slow', overbought=84, oversold=33)
    ...
    builder.set_strategy_info('Strategy_FAST_20260220_101234_01', '1.0.0')
