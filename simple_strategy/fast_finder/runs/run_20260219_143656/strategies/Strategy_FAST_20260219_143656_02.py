"""Generated strategy: Strategy_FAST_20260219_143656_02"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_indicator('ema_fast', ema, period=6)
    builder.add_indicator('ema_slow', ema, period=33)
    builder.add_indicator('macd_main', macd, fast_period=18, slow_period=35, signal_period=12)
    builder.add_indicator('rsi_main', rsi, period=28)
    builder.add_indicator('sma_fast', sma, period=5)
    builder.add_indicator('sma_slow', sma, period=87)
    builder.add_signal_rule('rsi_osob', overbought_oversold, indicator='rsi_main', overbought=81, oversold=26)
    builder.add_signal_rule('sma_cross', ma_crossover, fast_ma='sma_fast', slow_ma='sma_slow')
    builder.add_signal_rule('rsi_trend_combo', rsi_mean_reversion_with_trend, rsi='rsi_main', ema_fast='ema_fast', ema_slow='ema_slow', overbought=79, oversold=22)
    ...
    builder.set_strategy_info('Strategy_FAST_20260219_143656_02', '1.0.0')
