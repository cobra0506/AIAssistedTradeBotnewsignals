"""Generated strategy: Strategy_FAST_20260219_143656_09"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_indicator('ema_fast', ema, period=14)
    builder.add_indicator('ema_slow', ema, period=106)
    builder.add_indicator('macd_main', macd, fast_period=7, slow_period=21, signal_period=13)
    builder.add_indicator('rsi_main', rsi, period=17)
    builder.add_indicator('sma_fast', sma, period=15)
    builder.add_indicator('sma_slow', sma, period=94)
    builder.add_signal_rule('rsi_osob', overbought_oversold, indicator='rsi_main', overbought=82, oversold=21)
    builder.add_signal_rule('sma_cross', ma_crossover, fast_ma='sma_fast', slow_ma='sma_slow')
    builder.add_signal_rule('rsi_trend_combo', rsi_mean_reversion_with_trend, rsi='rsi_main', ema_fast='ema_fast', ema_slow='ema_slow', overbought=76, oversold=26)
    ...
    builder.set_strategy_info('Strategy_FAST_20260219_143656_09', '1.0.0')
