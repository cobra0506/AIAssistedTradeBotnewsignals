...
class SimpleStrategyGUI:
    ...
    def optimize_from_backtest_tab(self):
        ...
        trials_var = self.optimization_trials_var
        ...
        ttk.Label(content_frame, text="Realism Settings", font=("Arial", 10, "bold")).pack(pady=5)
        ...
        ttk.Checkbutton(content_frame, text="Walk-forward (slower, more realistic)", variable=self.walk_forward_var).pack()
        ...
        ttk.Checkbutton(content_frame, text="Next-bar fills (realistic)", variable=self.next_bar_var).pack()
        ...
        ttk.Label(content_frame, text="Leverage (x):").pack()
        ...
        ttk.Entry(content_frame, textvariable=self.leverage_var).pack()
        ...
        def run_optimization():
            ...
            try:
                ...
                backtest_config['export_chart'] = not walk_forward
                ...
                # Create parameter space based on strategy parameters
                ...
                param_space = self._build_parameter_space(strategy_name)
                ...
                if walk_forward:
                    ...
                    if not results:
                        ...
                        messagebox.showinfo("Optimization Results", "No walk-forward windows. Check date range.")
                    ...
                    best_window = max(results, key=lambda r: r.get('test_score', float('-inf')))
                    saved_params = False
                    if isinstance(best_window, dict):
                        ...
                        if isinstance(best_params, dict) and best_params:
                            try:
                                from simple_strategy.trading.parameter_manager import ParameterManager
                                pm = ParameterManager()
                                pm.update_parameters(strategy_name, best_params.copy())
                                saved_params = True
                            except Exception:
                                saved_params = False
                    ...
                    result_msg = "Walk-forward complete!\n\n"
                    ...
                    result_msg += "Windows: " + str(len(results)) + "\n"
                    ...
                    result_msg += "Average Test Score: " + str(round(avg_test, 4)) + "\n"
                    ...
                    result_msg += "Results saved to: simple_strategy/optimization_results/walk_forward_results.json\n"
                    if saved_params:
                        result_msg += "Best params saved to: simple_strategy/optimization_results/optimized_parameters.json\n"
                    else:
                        result_msg += "Warning: Best params not saved\n"
    ...
    def create_backtest_tab(self):
        ...
        ttk.Button(config_frame, text="?? Check Data Files", command=self.check_data_files).grid(row=6, column=0, columnspan=2, pady=5)
        ...
        ttk.Label(trading_frame, text="Leverage (x):").grid(row=3, column=0, sticky="w", padx=5, pady=2)
        ...
        ttk.Entry(trading_frame, textvariable=self.leverage_var, width=15).grid(row=3, column=1, padx=5, pady=2)
        ...
        ttk.Checkbutton(trading_frame, text="Walk-forward (slower, more realistic)", variable=self.walk_forward_var).grid(row=4, column=0, columnspan=2, sticky="w", padx=5, pady=2)
        ...
        ttk.Checkbutton(trading_frame, text="Next-bar fills (realistic)", variable=self.next_bar_var).grid(row=5, column=0, columnspan=2, sticky="w", padx=5, pady=2)
        ...
        ttk.Label(config_frame, text="Optimization Trials (walk-forward):").grid(row=4, column=0, sticky="w", padx=5, pady=5)
        ...
        ttk.Entry(config_frame, textvariable=self.optimization_trials_var, width=40).grid(row=4, column=1, padx=5, pady=5)
        ...
        self.open_chart_btn = ttk.Button(config_frame, text="Open Chart", command=self.open_backtest_chart, state="disabled")
        ...
        self.open_chart_btn.grid(row=6, column=0, columnspan=2, pady=5)
        ...
        self.last_backtest_chart_path = None
    ...
    def _build_parameter_space(self, strategy_name):
        ...
        """Build a ParameterSpace from STRATEGY_PARAMETERS."""
        ...
        from simple_strategy.optimization import ParameterSpace
        ...
        params = strategy_info.get('parameters', {}) or {}
        ...
        for param_name, param_def in params.items():
            ...
            ptype = str(param_def.get('type', '')).lower()
            ...
            if ptype == 'int':
                ...
                low = int(param_def.get('min', param_def.get('default', 0)))
                ...
                high = int(param_def.get('max', low))
                ...
                param_space.add_int(param_name, low, high, step)
                ...
                low = float(param_def.get('min', param_def.get('default', 0.0)))
                ...
                high = float(param_def.get('max', low))
                ...
                param_space.add_float(param_name, low, high)
                ...
                options = param_def.get('options') or param_def.get('choices') or []
                ...
                if not options:
                    ...
                    options = [default] if default is not None else []
                ...
                param_space.add_categorical(param_name, [True, False])
                ...
                if default is not None:
                    ...
                    param_space.add_categorical(param_name, [default])
    ...
    def open_backtest_chart(self):
        ...
        path = getattr(self, 'last_backtest_chart_path', None)
        ...
        if not path or not os.path.exists(path):
            ...
            messagebox.showerror("Error", "Chart file not found")
    ...
    def run_backtest(self):
        ...
        try:
            ...
            optimization_trials = int(self.optimization_trials_var.get())
        ...
        if hasattr(self, 'open_chart_btn'):
            ...
            self.open_chart_btn.config(state="disabled")
        ...
        def backtest_task():
            ...
            try:
                ...
                self.results_text.insert(tk.END, f"Next-bar Fills: {'ON' if next_bar_fills else 'OFF'}\n")
                ...
                self.results_text.insert(tk.END, f"Walk-forward: {'ON' if walk_forward else 'OFF'}\n")
                ...
                if walk_forward:
                    ...
                    self.results_text.insert(tk.END, f"Optimization Trials: {optimization_trials}\n")
                ...
                if walk_forward:
                    ...
                    strategy_name_for_opt = self.strategy_var.get()
                    ...
                    from simple_strategy.optimization import BayesianOptimizer
                    ...
                    optimizer = BayesianOptimizer(
                        ...
                        study_name=f"{strategy_name_for_opt}_walk_forward",
                    ...
                    param_space = self._build_parameter_space(strategy_name_for_opt)
                    ...
                    def update_opt_progress(completed_trials, total_trials):
                    ...
                    # Adjust walk-forward window sizes for short date ranges
                    ...
                    if total_days > 0 and (train_days + test_days) > total_days:
                        ...
                        # Keep a reasonable split for short ranges
                        ...
                        train_days = max(1, total_days - test_days)
                        ...
                        self.results_text.insert(tk.END, f"Adjusted walk-forward window for short range: train={train_days}d, test={test_days}d\n")
                    ...
                    results = optimizer.optimize_walk_forward(
                        ...
                        strategy_name=strategy_name_for_opt,
                    ...
                    self.results_text.insert(tk.END, "WALK-FORWARD RESULTS\n")
                    ...
                    if not results:
                        ...
                        self.results_text.insert(tk.END, f"Windows: {len(results)}\n")
                        ...
                        self.results_text.insert(tk.END, f"Average Test Score (Sharpe): {avg_test:.4f}\n")
                        ...
                        self.results_text.insert(tk.END, "Saved to: simple_strategy/optimization_results/walk_forward_results.json\n")
                        ...
                        metrics_windows = [w.get('test_metrics', {}) for w in results if isinstance(w, dict)]
                        ...
                        metrics_windows = [m for m in metrics_windows if m]
                        ...
                        if metrics_windows:
                            ...
                            avg_win_rate = sum(m.get('win_rate', 0.0) for m in metrics_windows) / len(metrics_windows)
                            ...
                            avg_sharpe = sum(m.get('sharpe_ratio', 0.0) for m in metrics_windows) / len(metrics_windows)
                            ...
                            avg_drawdown = sum(m.get('max_drawdown', 0.0) for m in metrics_windows) / len(metrics_windows)
                            ...
                            avg_return = sum(m.get('total_return', 0.0) for m in metrics_windows) / len(metrics_windows)
                            ...
                            total_trades = int(sum(m.get('total_trades', 0) for m in metrics_windows))
                            ...
                            total_pnl = (avg_return / 100) * start_amount
                            ...
                            self.results_text.insert(tk.END, "WALK-FORWARD SUMMARY (TEST WINDOWS)\n")
                            ...
                            self.results_text.insert(tk.END, f"Total Return: {avg_return:.2f}%\n")
                            ...
                            self.results_text.insert(tk.END, f"Win Rate: {avg_win_rate:.2f}%\n")
                            ...
                            self.results_text.insert(tk.END, f"Sharpe Ratio: {avg_sharpe:.2f}\n")
                            ...
                            self.results_text.insert(tk.END, f"Max Drawdown: {avg_drawdown:.2f}%\n")
                            ...
                            # Fallback: use last backtest results if walk-forward windows have no metrics
                            ...
                            try:
                                ...
                                if os.path.exists(results_path):
                                    ...
                                    _entry = _data.get(strategy_name_for_opt)
                                    ...
                                    if _entry and isinstance(_entry, dict):
                                        ...
                                        avg_return = _m.get('total_return', 0.0)
                                        ...
                                        avg_win_rate = _m.get('win_rate', 0.0)
                                        ...
                                        avg_sharpe = _m.get('sharpe_ratio', 0.0)
                                        ...
                                        avg_drawdown = _m.get('max_drawdown', 0.0)
                                        ...
                                        total_trades = int(_m.get('total_trades', 0))
                                        ...
                                        self.results_text.insert(tk.END, "WALK-FORWARD SUMMARY (LAST BACKTEST)\n")
                    ...
                    chart_path = results.get('chart_path') if isinstance(results, dict) else None
                ...
                if chart_path:
                    ...
                    self.last_backtest_chart_path = chart_path
                    ...
                    if hasattr(self, 'open_chart_btn'):
                        ...
                        self.open_chart_btn.config(state="normal")
    ...
    def _get_batch_backtest_settings(self, require_trials=False):
        ...
        if not symbols or not timeframes:
            ...
            messagebox.showerror("Error", "Please enter symbols and timeframes first")
        ...
        try:
            ...
            if initial_balance <= 0 or max_positions <= 0 or risk_per_trade <= 0:
        ...
        if require_trials or walk_forward:
            ...
            try:
                ...
                messagebox.showerror("Error", "Invalid optimization trials!")
