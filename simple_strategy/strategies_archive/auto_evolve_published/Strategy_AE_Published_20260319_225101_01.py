"""Generated strategy: Strategy_AE_Published_20260319_225101_01"""
...
def create_strategy(symbols=None, timeframes=None, **params):
    ...
    builder.add_filter_rule('price_bias', price_change_bias_filter, entry_timeframe='1m', price_change_threshold=0.011)
    builder.set_signal_combination('majority_vote')
    builder.set_strategy_info('Strategy_AE_Published_20260319_225101_01', '1.0.0')
